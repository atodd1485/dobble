...
class SimpleTwoPlayer(Game):
    ...
    def higlight_matching_images(self):
        ...
        for el in match:
            self.cards[0].higlight_image(el,highlight_colour=(255,255,255))
            self.cards[1].higlight_image(el,highlight_colour=(255,255,255))
    ...
    def event_higlight_scores(self):
        if not self.cards_highlighted:
    ...
    def load_events(self):
        self.event_handlers +=  [ EventHandler(self.event_player_1_score,  self.DEBOUNCE_TIME, pygame.MOUSEBUTTONDOWN),
                                  EventHandler(self.event_player_2_score,  self.DEBOUNCE_TIME, pygame.KEYDOWN, event_key=pygame.K_LCTRL),
                                  EventHandler(self.event_reset_scores,    self.DEBOUNCE_TIME, pygame.KEYDOWN, event_key=pygame.K_RCTRL),
                                  EventHandler(self.event_higlight_scores, self.DEBOUNCE_TIME, pygame.KEYDOWN, event_key=pygame.K_SPACE) ]
